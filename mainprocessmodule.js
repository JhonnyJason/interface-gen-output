...
(function() {
  var HJSON, cfg, extractEndpointDefinition, fs, log, mainprocessmodule, olog, ostr, path, print;
  ...
  extractEndpointDefinition = function(slice) {
    var definitionEndKey, definitionStartKey, requestDefinition, requestDefinitionEnd, requestDefinitionStart, requestDefinitionString, requestIndex, requestKey, responseDefinitionEnd, responseDefinitionStart, responseDefinitionString, responseIndex, responseKey, route, routeDetect;
