...
(function() {
  var HJSON, definitionEndKey, definitionStartKey, definitionfilemodule, extractFromSlice, extractInterface, file, fs, interfaceObject, log, olog, ostr, p, print, requestKey, responseKey, routeDetect, routeKey, sliceFile, slices;
