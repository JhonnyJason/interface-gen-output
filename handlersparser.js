...
//###########################################################
//region debug
var CO_count, CommentObject, DocumentBlock, ESO_count, EmptySpaceObject, FO_count, FunctionObject, ImportLine, LineObject, SH_count, SectionHead, VersionHeadline, argsDetect, commentKey, contentDetect, functionCenter, functionEnd, functionHeadlineTemplate, functionKey, getLineLevel, getLineType, lineToBlockType, lineToBlockTypeMap, lineTypes, log, olog, routeDetect, sectionHeadCommentKey, separatorLine, separatorLineKey, serviceDefinitionLine, setServiceLine, versionDetect;
...
//endregion
  ...
  //###########################################################
export var HandlersFileParser = class HandlersFileParser {
  constructor() {
    var err;
    try {
      this.path = ph.getHandlersFilePath();
      log("reading handlers file from: " + this.path);
