...
//###########################################################
//region debug
var DocumentSection, addRoute, createArgsBlock, definitionEndKey, definitionStartKey, digestNextLine, extractFromSlice, extractInterface, file, idCount, interfaceObject, log, olog, requestKey, responseKey, routeDetect, routeKey, sliceFile, slices;
...
//###########################################################
digestNextLine = function(line, file) {
  if (file.currentSection == null) {
    file.currentSection = new DocumentSection("head");
  }
};
